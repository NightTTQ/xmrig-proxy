...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool(kDonateHost, 6667, donate_user, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_POOL));
#   else
    m_client->setPool(Pool(kDonateHost, 6666, donate_user, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_POOL));
#   endif
