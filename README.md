...
The codebase is shared with the [XMRig](https://github.com/NightTTQ/xmrig) miner.
...
* Git tree: https://github.com/NightTTQ/xmrig-proxy.git
  * Clone with `git clone https://github.com/NightTTQ/xmrig-proxy.git` :hammer: [Build instructions](https://xmrig.com/docs/proxy).
  
## Usage
:boom: If you are using Linux and need to manage over **1000 connections**, you must [increase the limits on open files](https://github.com/NightTTQ/xmrig-proxy/wiki/Ubuntu-setup).
